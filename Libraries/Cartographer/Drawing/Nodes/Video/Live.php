...
/**
 * Video 'Live Stream' Node Tag | Cartographer\Tags\Video\Live.php
 *
...
/**
 * Describes a Video Live Stream with the `<video:live>` Tag
 *
 ...
 */
class Live extends AbstractNode {
    ...
    public function draw( Pen $pen ) {
        ...
        $pen -> addChildren(
            'video:live', strtolower( $this -> options -> data )
        );
    }
    ...
    /**
     * Validates the Tag.
     * Live Stream Tag accepts either 'yes' or 'no' as possible values
     * indicating the Video is a Live Stream or not
     *
     * @return boolean
    ...
    public function validate() {
        ...
        if( $data != 'yes' && $data != 'no' ) {
            ...
            $this -> _error = 'Live Stream Flag accepts only \'yes\' or \'no\' as possible values';
     ...
     *
     * @return boolean
     *  TRUE because 'Live Stream' Tag describes a single content and
