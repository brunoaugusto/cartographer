...
/**
 * Video 'Expiration Date' Node Tag | Cartographer\Tags\Video\ExpirationDate.php
 *
...
/**
 * Describes a Video Expiration Date with the `<video:expiration_date>` Tag
 *
 ...
 */
class ExpirationDate extends AbstractNode {
    ...
    public function draw( Pen $pen ) {
        ...
        $pen -> addChildren(
            'video:expiration_date', $this -> options -> data
        );
    }
    ...
    /**
     * Validates the Tag.
     * A W3C DateTime compliant representing when the Video will not
    ...
    public function validate() {
        ...
        if( ! $validator -> validate() ) {
            ...
            $this -> _error = 'Expiration Date is not in a valid W3C DateTime Format';
     ...
     *
     * @return boolean
     *  TRUE because 'Expiration Date' Tag describes a single content and
